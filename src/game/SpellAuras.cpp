...
void Aura::HandleAuraModStat(bool apply, bool /*Real*/)
{
    ...
    {
        sLog.outError("¾¯¸æ£º Spell %u effect %u have unsupported misc value (%i) for SPELL_AURA_MOD_STAT ",GetId(),GetEffIndex(),m_modifier.m_miscvalue);
        return;
    }
...
void Aura::HandleModPercentStat(bool apply, bool /*Real*/)
{
    ...
    {
        sLog.outError("¾¯¸æ£º Misc Value for SPELL_AURA_MOD_PERCENT_STAT not valid");
        return;
    }
...
void SpellAuraHolder::AddAura(Aura aura, SpellEffectIndex index)
{
    ...
    {
        DEBUG_LOG("SpellAuraHolder::AddAura attempt to add aura (effect %u) to holder of spell %u, µ« holder already have active aura!", index, GetId());
        RemoveAura(index);
    }
