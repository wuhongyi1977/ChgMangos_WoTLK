...
{
    DEBUG_LOG("世界： CMSG_CALENDAR_GET_CALENDAR");         // empty
...
{
    DEBUG_LOG("世界： CMSG_CALENDAR_GET_EVENT");
    recv_data.hexlike();
...
{
    DEBUG_LOG("世界： CMSG_CALENDAR_GUILD_FILTER");
    recv_data.hexlike();
...
{
    DEBUG_LOG("世界： CMSG_CALENDAR_ARENA_TEAM");
    recv_data.hexlike();
...
{
    DEBUG_LOG("世界： CMSG_CALENDAR_ADD_EVENT");
    recv_data.hexlike();
...
{
    DEBUG_LOG("世界： CMSG_CALENDAR_UPDATE_EVENT");
    recv_data.hexlike();
    recv_data.rpos(recv_data.wpos());                       // set to end to avoid warnings spam
...
{
    DEBUG_LOG("世界： CMSG_CALENDAR_REMOVE_EVENT");
    recv_data.hexlike();
    recv_data.rpos(recv_data.wpos());                       // set to end to avoid warnings spam
...
{
    DEBUG_LOG("世界： CMSG_CALENDAR_COPY_EVENT");
    recv_data.hexlike();
    recv_data.rpos(recv_data.wpos());                       // set to end to avoid warnings spam
...
{
    DEBUG_LOG("世界： CMSG_CALENDAR_EVENT_INVITE");
    recv_data.hexlike();
    recv_data.rpos(recv_data.wpos());                       // set to end to avoid warnings spam
...
{
    DEBUG_LOG("世界： CMSG_CALENDAR_EVENT_RSVP");
    recv_data.hexlike();
    recv_data.rpos(recv_data.wpos());                       // set to end to avoid warnings spam
...
{
    DEBUG_LOG("世界： CMSG_CALENDAR_EVENT_REMOVE_INVITE");
    recv_data.hexlike();
    recv_data.rpos(recv_data.wpos());                       // set to end to avoid warnings spam
...
{
    DEBUG_LOG("世界： CMSG_CALENDAR_EVENT_STATUS");
    recv_data.hexlike();
    recv_data.rpos(recv_data.wpos());                       // set to end to avoid warnings spam
...
{
    DEBUG_LOG("世界： CMSG_CALENDAR_EVENT_MODERATOR_STATUS");
    recv_data.hexlike();
    recv_data.rpos(recv_data.wpos());                       // set to end to avoid warnings spam
...
{
    DEBUG_LOG("世界： CMSG_CALENDAR_COMPLAIN");
    recv_data.hexlike();
    recv_data.rpos(recv_data.wpos());                       // set to end to avoid warnings spam
...
{
    DEBUG_LOG("世界： CMSG_CALENDAR_GET_NUM_PENDING");      // empty
