...
{
    DEBUG_LOG("世界： Received CMSG_REQUEST_PARTY_MEMBER_STATS");
    ObjectGuid guid;
    recv_data >> guid;
...
{
    DEBUG_LOG("世界： Received CMSG_OPT_OUT_OF_LOOT");
...
{
    DEBUG_LOG("世界： Received CMSG_SET_ALLOW_LOW_LEVEL_RAID: %4X", recv_data.GetOpcode());
