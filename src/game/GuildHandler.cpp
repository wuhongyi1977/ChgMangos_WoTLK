...
{
    DEBUG_LOG("世界： Received CMSG_GUILD_QUERY");
...
{
    DEBUG_LOG("世界： Received CMSG_GUILD_CREATE");
...
{
    DEBUG_LOG("世界： Received CMSG_GUILD_INVITE");
    ...
    DEBUG_LOG("世界： Sent (SMSG_GUILD_INVITE)");
}

void WorldSession::HandleGuildRemoveOpcode(WorldPacket& recvPacket)
{
    DEBUG_LOG("世界： Received CMSG_GUILD_REMOVE");
...
void WorldSession::HandleGuildAcceptOpcode(WorldPacket& /*recvPacket*/)
{
    ...
    DEBUG_LOG("世界： Received CMSG_GUILD_ACCEPT");
...
{
    DEBUG_LOG("世界： Received CMSG_GUILD_DECLINE");
...
{
    DEBUG_LOG("世界： Received CMSG_GUILD_INFO");
...
{
    DEBUG_LOG("世界： Received CMSG_GUILD_ROSTER");
...
{
    DEBUG_LOG("世界： Received CMSG_GUILD_PROMOTE");
...
{
    DEBUG_LOG("世界： Received CMSG_GUILD_DEMOTE");
...
{
    DEBUG_LOG("世界： Received CMSG_GUILD_LEAVE");
...
{
    DEBUG_LOG("世界： Received CMSG_GUILD_DISBAND");
    ...
    DEBUG_LOG("世界： Guild Successfully Disbanded");
}

void WorldSession::HandleGuildLeaderOpcode(WorldPacket& recvPacket)
{
    DEBUG_LOG("世界： Received CMSG_GUILD_LEADER");
...
{
    DEBUG_LOG("世界： Received CMSG_GUILD_MOTD");
...
{
    DEBUG_LOG("世界： Received CMSG_GUILD_SET_PUBLIC_NOTE");
...
{
    DEBUG_LOG("世界： Received CMSG_GUILD_SET_OFFICER_NOTE");
...
void WorldSession::HandleGuildRankOpcode(WorldPacket& recvPacket)
{
    ...
    DEBUG_LOG("世界： Received CMSG_GUILD_RANK");
    ...
    DEBUG_LOG("世界： Changed RankName to %s , Rights to 0x%.4X", rankname.c_str(), rights);
...
{
    DEBUG_LOG("世界： Received CMSG_GUILD_ADD_RANK");
...
{
    DEBUG_LOG("世界： Received CMSG_GUILD_DEL_RANK");
...
void WorldSession::SendGuildCommandResult(uint32 typecmd, const std::string& str,uint32 cmdresult)
{
    ...
    DEBUG_LOG("世界： Sent (SMSG_GUILD_COMMAND_RESULT)");
}

void WorldSession::HandleGuildChangeInfoTextOpcode(WorldPacket& recvPacket)
{
    DEBUG_LOG("世界： Received CMSG_GUILD_INFO_TEXT");
...
{
    DEBUG_LOG("世界： Received MSG_SAVE_GUILD_EMBLEM");
    ...
    if (!pCreature)
    {
        ...
        DEBUG_LOG("世界： HandleSaveGuildEmblemOpcode - %s not found or you can't interact with him.", vendorGuid.GetString().c_str());
        return;
    }
...
{
                                                            // empty
    DEBUG_LOG("世界： Received (MSG_GUILD_EVENT_LOG_QUERY)");
...
{
    DEBUG_LOG("世界： Received (MSG_GUILD_BANK_MONEY_WITHDRAWN)");
...
{
    DEBUG_LOG("世界： Received (MSG_GUILD_PERMISSIONS)");
    ...
    if(uint32 GuildId = GetPlayer()->GetGuildId())
    {
        if (Guild* pGuild = sGuildMgr.GetGuildById(GuildId))
        {
            ...
            SendPacket(&data);
            DEBUG_LOG("世界： Sent (MSG_GUILD_PERMISSIONS)");
        }
    }
}
...
{
    DEBUG_LOG("世界： Received (CMSG_GUILD_BANKER_ACTIVATE)");
...
{
    DEBUG_LOG("世界： Received (CMSG_GUILD_BANK_QUERY_TAB)");
...
{
    DEBUG_LOG("世界： Received (CMSG_GUILD_BANK_DEPOSIT_MONEY)");
...
{
    DEBUG_LOG("世界： Received (CMSG_GUILD_BANK_WITHDRAW_MONEY)");
...
{
    DEBUG_LOG("世界： Received (CMSG_GUILD_BANK_SWAP_ITEMS)");
...
{
    DEBUG_LOG("世界： Received (CMSG_GUILD_BANK_BUY_TAB)");
...
{
    DEBUG_LOG("世界： Received (CMSG_GUILD_BANK_UPDATE_TAB)");
...
{
    DEBUG_LOG("世界： Received (MSG_GUILD_BANK_LOG_QUERY)");
...
{
    DEBUG_LOG("世界： Received MSG_QUERY_GUILD_BANK_TEXT");
...
{
    DEBUG_LOG("世界： Received CMSG_SET_GUILD_BANK_TEXT");
