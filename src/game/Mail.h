...
class MailDraft
{
    ...
    public:                                                 // modifiers
        ...
        // this two modifiers expected to be applied in normal case to blank draft and exclusively, it will work and with mixed cases µ«¸Ã will be not normal way use.
